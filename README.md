...
AI coding assistants, including Codex, Claude, Gemini, and GitHub Copilot, were used as auxiliary software-engineering tools for repository organization, documentation editing, boilerplate generation, and code-review support. They did not define the physics, benchmark claims, validation criteria, or scientific conclusions.
