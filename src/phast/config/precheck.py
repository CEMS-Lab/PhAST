...
-----
    ...
    # From a YAML config:
    python -m phast.tools.pre_simulation_calculator \
        --config configs/benchmarks/dynamic/B1_branching_glass.yaml
...
Examples:
  ...
  # From YAML config:
  %(prog)s --config configs/benchmarks/dynamic/B1_branching_glass.yaml
...
def _run_compare():
    ...
    presets = [
        ...
        'basalt_brazilian', 'soda_lime_glass',
    ]
