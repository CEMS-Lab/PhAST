...
explicit dynamics, quasi-static validation, and beta plasticity/cohesive
...
phase-field equations and can expose supported computations to autograd. The
public CEMS-Lab release is a forward fracture and plasticity/cohesive
validation solver.
...
| Plasticity/cohesive validation | Run guarded J2 plasticity, ductile AT2, cohesive, contact, and PF-CZM validation examples within the documented beta boundaries. |
...
| Benchmarks | `docs/benchmarks/catalogue.md`, `docs/benchmarks/examples.md`, and `configs/BENCHMARK_RUN_MAP.md` |
| Examples | `examples/README.md` and `docs/example-gallery.md` |
| Developer internals | `docs/developer/architecture.md`, `docs/developer/matrix_free.md`, and `docs/developer/testing.md` |

GitHub workflows are currently manual-only. Run CI, docs, install checks, wheel
builds, or Claude jobs from the GitHub Actions tab when needed.
