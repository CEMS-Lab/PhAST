...
| `dynamic_timing_comparison.png` | Dynamic fracture timing | Regenerated from the current private SENT and Kalthoff-Winkler Akantu/FEniCS/PhAST timing CSVs; companion data in `dynamic_timing_comparison.csv` |
