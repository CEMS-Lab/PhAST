...
| Implementation status here  | public beta validation    | public beta validation     | documented comparison target  |

COMSOL's 6.2/6.4 Damage attribute exposes Power-law (m=1, m=2 ⇒ PF-CZM-equivalent),
...
parity supports B5/B6 style head-to-head comparisons.
...
sufficient mesh resolution. The formulation summary follows public Abaqus
cohesive-zone documentation and the standard bilinear/exponential
traction-separation literature.
...
- Abaqus 2024 *Materials Reference* — cohesive surfaces / cohesive
  ...
  (formulation summary from public Abaqus documentation conventions and
  Wu–Nguyen 2020 §4.4 cross-reference).
