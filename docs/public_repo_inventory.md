...
|---|---|---|
| Critical | `examples/dynamic/B7_dynamic_crack_branching_comsol/` | Some manifests expose absolute private/HPC paths. Sanitize before public release. |
...
| Medium | Packaging | `pyproject.toml` still includes old `torch_pf_solver*` package discovery. Remove before final public release. |
