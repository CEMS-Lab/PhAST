...
cohesive-interface, and PF-CZM examples. It is appropriate
...
> and PF-CZM uniaxial strength validation, with reproducible YAML contracts
> and visual/provenance artifacts.
