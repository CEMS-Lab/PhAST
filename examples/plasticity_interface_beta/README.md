...
result = phast.load_result("examples/plasticity_interface_beta/results/structural_dcb_cohesive")
...
python examples/plasticity_interface_beta/run_diffuse_interphase_validation.py \
  --output-dir outputs/plasticity_interface/diffuse_interphase

python examples/plasticity_interface_beta/run_solid_interface_fracture_examples.py \
  --output-dir outputs/plasticity_interface/solid_interface_fracture

python examples/plasticity_interface_beta/run_solver_driven_interface_fracture_validation.py \
...
python examples/plasticity_interface_beta/run_structural_dcb_refinement_study.py \
  --output-dir outputs/plasticity_interface/structural_dcb_refinement

python examples/plasticity_interface_beta/run_coupled_pf_cohesive_benchmark.py \
...
```bash
python examples/plasticity_interface_beta/run_q4_sparse_at2_smoke.py \
...
```bash
python examples/plasticity_interface_beta/run_ductile_pf_backend_promotion.py \
