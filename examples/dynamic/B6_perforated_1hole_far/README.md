...
Curated PMMA dynamic fracture variant with a single far crack-path hole from the Bleyer et al. (2017) perforated-plate family. The public folder keeps the YAML configuration and lightweight reference run
