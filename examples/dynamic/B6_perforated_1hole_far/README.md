...
Curated PMMA dynamic-fracture variant with a single far crack-path hole. This
...
python -m phast run examples/dynamic/B6_perforated_1hole_far/config.yaml --output_dir runs/B6_perforated_1hole_far
```
