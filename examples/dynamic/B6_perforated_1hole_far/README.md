...
Curated PMMA dynamic fracture variant with a single hole farther from the crack path from the Bleyer et al. (2017) perforated-plate family. This public B6 folder retains lightweight artifacts from the reference run.
...
- 32 mm x 16 mm PMMA SENT plate with one hole at the far-hole placement and public B6 naming.
- Hole layout: 1 hole at x = 10.0 mm with vertical offset 0.6 mm; hole diameter is 0.4 mm.
...
```bash
gmsh examples/dynamic/B6_perforated_1hole_far/mesh.geo \
  -2 -format msh2 \
  -o examples/dynamic/B6_perforated_1hole_far/mesh.msh
```
...
|---|---|
| <img src="initial_conditions.png" alt="B6 Perforated 1-Hole Far Plate initial conditions" width="360"> | <img src="damage_evolution.gif" alt="B6 Perforated 1-Hole Far Plate damage evolution" width="360"> |

| Quantity | Reference evidence | Status |
| --- | --- | --- |
| Recorded run | Retained B6 reference run; 53,395 nodes, 106,199 elements, 101,295 explicit steps | PRESENT |
| Hole layout | 1 hole at x = 10.0 mm with vertical offset 0.6 mm | DOCUMENTED |
