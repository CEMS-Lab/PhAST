...
| `mesh_convergence.png` | Reference PNG visual: mesh convergence. |
...
| `velocity_parametric.png` | Reference PNG visual: velocity parametric. |
...
|---|---|
| <img src="initial_conditions.png" alt="B5 PMMA Branching initial conditions" width="360"> | <img src="damage_multipanel.png" alt="B5 PMMA Branching reference result" width="360"> |
