"""Run the B6 perforated 10-hole plate example without a YAML configuration."""
...
def build_problem(num_steps: int | None = None) -> phast.Problem:
    problem = phast.Problem("Perforated Plate — 10 holes")
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run B6 10-hole perforated plate through the Python API.")
    parser.add_argument("--output-dir", default="examples/dynamic/B6_perforated_10holes/run_fluent")
