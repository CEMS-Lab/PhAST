...
Curated PMMA perforated-plate dynamic fracture variant based on the Bleyer et al. (2017) crack-hole interaction setup. This flat example keeps the YAML configuration and lightweight reference run
