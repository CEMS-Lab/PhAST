...
Curated PMMA perforated-plate dynamic fracture variant based on the Bleyer et al. (2017) crack-hole interaction setup. This flat example keeps the YAML deck and lightweight reference run
...
|---|---|
| <img src="initial_conditions.png" alt="B6 Perforated 10-Hole Plate initial conditions" width="360"> | <img src="damage_multipanel.png" alt="B6 Perforated 10-Hole Plate reference result" width="360"> |

| Quantity | Reference evidence | Status |
| --- | --- | --- |
| Recorded run | Selected reference run | PRESENT |
| Hole layout | 10 holes, spacing 2.55 mm from run metadata | DOCUMENTED |
