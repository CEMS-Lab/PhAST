...
def build_problem(num_steps: int | None = None) -> phast.Problem:
    problem = phast.Problem("Perforated Plate — 1 hole near")
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run B6 1-hole near perforated plate through the Python API.")
    parser.add_argument("--output-dir", default="examples/dynamic/B6_perforated_1hole_near/run_fluent")
