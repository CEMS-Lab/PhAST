...
Curated PMMA dynamic fracture variant with a single near crack-path hole from the Bleyer et al. (2017) perforated-plate family. The public folder keeps the YAML deck and lightweight reference run
...
- 32 mm x 16 mm PMMA SENT plate with one hole at the near-hole placement.
...
|---|---|
| <img src="initial_conditions.png" alt="B6 Perforated 1-Hole Near Plate initial conditions" width="360"> | <img src="damage_multipanel.png" alt="B6 Perforated 1-Hole Near Plate reference result" width="360"> |

| Quantity | Reference evidence | Status |
| --- | --- | --- |
| Recorded run | Selected reference run | PRESENT |
| Hole layout | 1 hole at x = 5.0 mm from run metadata | DOCUMENTED |
