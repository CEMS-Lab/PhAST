...
Curated PMMA dynamic-fracture variant with a single near crack-path hole. This
...
python -m phast run examples/dynamic/B6_perforated_1hole_near/config.yaml --output_dir runs/B6_perforated_1hole_near
```
