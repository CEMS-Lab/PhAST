...
| --- | --- | --- | --- | --- |
| Linear elastic plate | Supporting solver example | Plane-strain CST cantilever, sparse autograd solve, displacement and stress fields | `python -m phast run examples/solid_mechanics_beta/linear_plate/config.yaml` | `response.csv`, final field PNGs, MP4 animations, manifests |
...
python examples/solid_mechanics_beta/neohookean_plate/run.py --config examples/solid_mechanics_beta/neohookean_plate/config.yaml
python examples/solid_mechanics_beta/j2_bar/run.py --config examples/solid_mechanics_beta/j2_bar/config.yaml
python examples/solid_mechanics_beta/linear_plate.py
python examples/solid_mechanics_beta/neohookean_plate.py
python examples/solid_mechanics_beta/j2_plasticity_bar.py
```
